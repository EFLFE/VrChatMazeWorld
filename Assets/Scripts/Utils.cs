...
public class Utils : UdonSharpBehaviour {
    ...
    public static void CreateJaggedArrayOfarrays(out int[][] array, int height, int width) {
    ...
    public static void CreateJaggedArrayOfarrays(out RoomTypeEnum[][] array, int height, int width) {
    ...
    public static void RemoveAllChildGameObjects(Transform transform, float time = 0f) {
